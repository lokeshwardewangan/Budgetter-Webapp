...
const itemSizing =
  'h-11 px-3 py-2.5 gap-3 text-base font-medium [&>svg]:!size-5 group-data-[collapsible=icon]:!size-11 group-data-[collapsible=icon]:!p-2.5 group-data-[collapsible=icon]:justify-center';
    ...
    <Sidebar collapsible="icon" className="font-karla">
      <SidebarHeader className="py-5">
        <Link
          ...
          className="flex items-center gap-2 pl-2.5 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:pl-0"
        >
